...
<template>
  <div class="center-svg">
    ...
    <!-- 烟花的动画 -->
    <img src="../assets/images/ling/lingxA.png" alt="" class="lingxA">
    <img src="../assets/images/ling/lingxB.png" alt="" class="lingxB">
    <img src="../assets/images/ling/lingxC.png" alt="" class="lingxC">
    <img src="../assets/images/ling/lingxD.png" alt="" class="lingxD">
    <img src="../assets/images/ling/lingxE.png" alt="" class="lingxE">
    <img src="../assets/images/ling/lingxF.png" alt="" class="lingxF">
  </div>
</template>
